...
class Book(models.Model):
    ...
    # Foreign Key is used because book can have one author, but authors can have multiple books
    #Author as a string rather than an object is because it hasnt been declared yet in the file
    author = models.ForeignKey('Author', on_delete=models.SET_NULL, null=True)
    summary = models.TextField(max_length=1000, help_text='Enter a brief description of the book.')
    isbn = models.CharField('ISBN', max_length=13, unique=True, help_text='13 Character <a href="https://www.isbn-international.org/content/what-isbn">isbn number</a>')

    # ManyToManyField used because book can contain genres and many genres can contain many books
